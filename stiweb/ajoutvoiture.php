...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <h2>Ajout/Modification de voiture</h2>
		  <?php
		  if(!isset($_SESSION["id"])){
			  header('Location: index.php');
		  }else{
			  print("<form action=\"ajoutvoituresend.php\" method=\"post\">
						
						<div class=\"form-group\">
						  <input name=\"immatriculation\" type=\"text\" placeholder=\"Immatriculation*\" class=\"form-control\" required>
						</div>
						<div class=\"form-group\">
						  <input name=\"marque\" type=\"text\" placeholder=\"Marque/Modèle*\" class=\"form-control\" required>
						</div>
						<div class=\"form-group\">
						  <input name=\"couleur\" type=\"text\" placeholder=\"Couleur*\" class=\"form-control\">
						</div>
