      ...
      <div class="row">
        <div class="col-md-4">
		  ...
		  if(isset($_SESSION["id"])){
			  ...
			  print("<form action=\"inscriptionsend.php\" method=\"post\">
						<div class=\"form-group\">
						  <input name=\"email\" type=\"email\" placeholder=\"Email*\" class=\"form-control\" required>
						</div>
						<div class=\"form-group\">
						  <input name=\"pass\" type=\"password\" placeholder=\"Mot de passe*\" class=\"form-control\" required>
						</div>
						<div class=\"form-group\">
						...
						<div class=\"form-group\">
						  <input name=\"noTel\" type=\"text\" placeholder=\"N° de téléphone\" class=\"form-control\">
						</div>
