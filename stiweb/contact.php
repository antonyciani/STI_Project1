  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>Dans le cadre du projet du cours BDR, ce site vise &agrave r&eacutepondre aux besoins des &eacutetudiants et professeurs de la HEIG pour leur permettre de partager leurs trajets afin d'en diminuer les co&ucircts pour leur porte monnaie mais aussi pour la plan&egravete.</p>
        <?php
		  if(!isset($_SESSION["id"])){
	...
	<div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
		  <h2>CIANI Antony<h2>
		  <h3>antony.ciani@heig-vd.ch</h3>
        </div>
		<div class="col-md-4">
		  <h2>HERNANDEZ Thomas<h2>
		  <h3>thomas.hernandez@heig-vd.ch</h3>
        </div>         
      </div>
      <hr>
    </div> <!-- /container -->
